...
const page = () => {
  return (
    ...
    <ul>
      <li className='text-xl font-semibold list-disc ml-8 mt-6 '>Filtru de habitaclu murdar </li>
      <li className='text-xl font-semibold list-disc ml-8 mt-2 '>Radiator înfundat</li>
      ...
      <li className='text-xl font-semibold list-disc ml-8 mt-2 '>Nivel redus al agentului de răcire</li>
    </ul>
    </div>
...
<p>Reumplerea sistemului de climatizare și schimbarea filtrului de habitaclu vă ofertă confortul termic ideal și o calitatea bună a aerului pe care îl respirați în timpul călătoriilor dumneavoastră. În general, recomandăm înlocuirea filtrului de habitaclu în fiecare an și reîncărcarea circuitului de climatizare la fiecare doi ani.</p>
